export const dynamic = "force-dynamic"; // ✅ Required for Next.js App Router dynamic API routes
...
/**
 * /api/horoscope
 * Generates daily Bengali-style horoscopes using astronomy-engine + luxon
 */
...
export async function GET(request) {
  try {
    // 🕵️ Get client IP (Vercel provides in headers)
